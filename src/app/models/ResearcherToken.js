...
class ResearcherToken extends Model {
  ...
  static associate(sequelize) {
    console.log('It called a Associate ResearcherToken');
    this.belongsTo(sequelize.models.Researcher, {
      foreignKey: 'researcher_id',
    });
  }
}

export default ResearcherToken;
